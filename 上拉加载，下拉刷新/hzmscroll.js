(function (name, definition) {
  ...
  HzmScroll.prototype.init = function () {
    ...
    this.scrollBody.insertBefore(
      wrapperDownwrap,
      this.scrollBody.childNodes[0]
    );
    // 为元素设置下拉加载的元素
  ...
  HzmScroll.prototype.upLoad = function () {
    ...
    function touchstartEvent(e) {
      ...
      _this.scrollBody.addEventListener(
        "touchmove",
        _this.myThrottle(touchmoveEvent, 60)
      );
    ...
    function touchmoveEvent(e) {
      ...
      _this.downwarProgress.style.transform = `rotate(${
        (change / 300) * 360
      }deg)`;
    }
